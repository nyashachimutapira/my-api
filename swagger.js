      ...
      schemas: {
        Contact: {
          ...
          properties: {
            ...
            lastName: { type: 'string', example: 'Tapedza' },
            ...
            street: { type: 'string', example: '123 Muda St' },
        ...
        ContactInput: {
          type: 'object',
          properties: {
            firstName: { type: 'string', example: 'Tinashe' },
            lastName: { type: 'string', example: 'Nhamo' },
            email: { type: 'string', format: 'email', example: 'nhamo@gmail.com' },
            phone: { type: 'string', example: '+263 771 000 111' },
            favoriteColor: { type: 'string', example: 'Blue' },
            birthday: { type: 'string', format: 'date', example: '1990-01-15' },
            jobTitle: { type: 'string', example: 'Software Engineer' },
            company: { type: 'string', example: '507f1f77bcf86cd799439012' },
            street: { type: 'string', example: '43 Main St' },
            city: { type: 'string', example: 'Harare' },
            country: { type: 'string', example: 'Zimbabwe' },
          },
          required: [
